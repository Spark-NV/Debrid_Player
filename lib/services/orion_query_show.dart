...
class OrionQueryShow {
  static final OrionQueryShow instance = OrionQueryShow._internal();
  OrionQueryShow._internal();

  final String _baseUrl = 'https://api.orionoid.com';
  
   Future<Map<String, dynamic>?> searchShow(String imdbId, int season, int episode) async {
    try {
      ...
      final commonParams = await OrionQueryHelper.getTVShowQueryParams();
      final Map<String, String> formData = {
          ...
          'idimdb': imdbId,
          'streamtype': 'torrent',
          'numberseason': season.toString(),
          'numberepisode': episode.toString(),
          'limitcount': '40',
          ...commonParams,
      };
